...
+ **Quick Index**
    ...
    + *OpenInMdless*(filename$) - opens a Markdown-formatted file in the mdless viewer. 
...
+ **OpenInMdless$**(filename$) - opens a given markdown-formatted text file in the *mdless* markdown viewer in the same terminal window as your program. 
